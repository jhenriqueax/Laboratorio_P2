...
class BuscaTest extends BaseTest {
	...
	@Test
	void testBuscaAvancadaUmMetadados() {
		Map<String, String> metadadosBuscados = new HashMap<>();
		
		metadadosBuscados.put("Teste", "Testaaaando");
	...
	@Test
	void testBuscaAvancadaMetadadosChaveVazio() {
		Map<String, String> metadadosBuscados = new HashMap<>();
		
		metadadosBuscados.put("", "Testando");
	...
	@Test
	void testBuscaAvancadaMetadadosValorVazio() {
		Map<String, String> metadadosBuscados = new HashMap<>();
